...
% identification or the application of additional algorithms.
...
Our final example differs from the previous ones in three important ways.  First, in each of our previous examples the subsurface geometry consisted of a small number of shapes.  In this example, we consider a subsurface region possessing a large number of layers and two anomalous bodies. Second, in this example we utilize seismic data arising from the acoustic waves which is also called full-waveform inversion (FWI). Third, our final example highlights the potential uplift from annealing strategies applied to Mumford-Shah.  
...
\bibliography{shape_inversion_final}
