...
The available data in this example is the first-arrival times associated with the 501 sources and 501 receivers, as illustrated in Figure~\ref{fig:301c}.  First-arrival travel times T for both data generation and inversion are computed by solving the Eikonal equation
