...
\caption{The true anisotropic permeability fields (a) $\kappa_{xx}/\kappa_{Ref}$ and (b) $\kappa_{zz}/\kappa{Ref}$, and the pressure field obtained using equation~\ref{eq:onephase} and permeability fields from (a) and (b).}
\label{fig:7}
\end{figure}
}
...
\caption{The inverted anistropic permeability fields (a) $\kappa_{xx}/\kappa_{Ref}$ and (b) $\kappa_{zz}/\kappa_{Ref}$ resulting from the conventional cell-based inversion.}
\label{fig:8}
\end{figure}
}
...
\caption{The inverted permeability tensor components (a) $\kappa_{xx}/\kappa_{Ref}$, (b) $\kappa_{zz}/\kappa_{Ref}$, and (c) the interface set $\phi_\epsilon$ resulting from the Mumford-Shah-based inversion.}
\label{fig:9}
\end{figure}
}
\sendatend{
